...
Além disso, o RetroVerso carrega os JSONs antes de iniciar o loader e converte os registros para `EJS_cheats`, garantindo compatibilidade com a versão do EmulatorJS utilizada no projeto.
...
Os arquivos já criados para o RetroVerso são:
